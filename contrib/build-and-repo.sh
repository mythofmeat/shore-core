#!/bin/bash
# Build shore-git package and upload to Gitea's Arch package registry.
#
...
echo ""
echo "Done! Package available in Gitea package registry."
echo ""
...
echo ""
echo "Then run: sudo pacman -Sy shore-git"

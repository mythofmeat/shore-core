...
- active `AGENTS.md`
- active `TOOLS.md`
- active snapshot `active_prompt/MEMORY.md`, refreshed from workspace `memory/MEMORY.md` at compaction/reload
...
- activating a rewritten `workspace/memory/MEMORY.md` snapshot

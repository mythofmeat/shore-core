...
TOOLS_OPENAI = [
    {"type": "function", "function": {"name": "memory_search", "description": "Search the character's markdown memory files for previous topics, facts, preferences, or shared history.", "parameters": {"type": "object", "properties": {"query": {"type": "string", "description": "Keyword or phrase to search for"}}, "required": ["query"]}}},

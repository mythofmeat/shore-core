...
Per-release sections from v1.8.3 onward are generated by release-plz from
conventional commits. The block below is unstructured legacy history covering
roughly v0.16.0 through v1.8.1. v1.8.2 was a one-off manual cut to advance
the release-plz baseline past path-dep manifests it couldn't package.

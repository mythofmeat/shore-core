...
cp -r GodotSynth/addons/GodotSynth clients/gui-godot/addons/GodotSynth
```
...
cp -r addon/addons/PostProcess clients/gui-godot/addons/PostProcess
```
...
cp -r anima-godot-4/addons/anima clients/gui-godot/addons/anima
```
...
cp -r Godot-4-Color-Correction-and-Screen-Effects/addons clients/gui-godot/addons/
```
